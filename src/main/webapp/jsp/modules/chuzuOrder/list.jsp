...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">房屋出租订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">房屋出租订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">房屋出租订单列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            deleteBtn.setAttribute("type", "button");
            deleteBtn.setAttribute("class", "btn btn-danger btn-sm 退房");
            deleteBtn.setAttribute("onclick", deleteAttr);
            deleteBtn.innerHTML = "退房";
            btnGroup.appendChild(deleteBtn);
            row.appendChild(btnGroup);
        ...
        // 删除
        function remove1(id) {
            var mymessage = confirm("真的要退房吗？");
            if (mymessage == true) {
                http("chuzuOrder/tuifang?ids="+id, "get", {}, (res) => {
                    if(res.code == 0){
                    getDataList();
                    alert('操作成功');
                }
