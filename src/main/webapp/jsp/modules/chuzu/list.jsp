        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">房屋出租管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">房屋出租列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">房屋出租列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(chuzuWeizhiCell);
                ...
                //详细信息
            var chuzuContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.chuzuContent && item.chuzuContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.chuzuContent.indexOf('<img');
                var endIndex = item.chuzuContent.indexOf('>');
                    chuzuContentCell.innerHTML = item.chuzuContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.chuzuContent != null && item.chuzuContent != "" && item.chuzuContent.length >= 11) {
                        chuzuContentCell.innerHTML = item.chuzuContent.substring(0, 10) + "...";
                } else {
                        chuzuContentCell.innerHTML = item.chuzuContent;
                }
            }
            row.appendChild(chuzuContentCell);
            ...
            //录入时间
            var insertTimeCell = document.createElement('td');
            insertTimeCell.innerHTML = item.chuzuTypes==1?"未租":item.chuzuTypes==2?"已租":"";
            row.appendChild(insertTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chuzu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchuzu", "addchuzu");
            window.location.href = "add-or-update.jsp"
        }
