        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">房屋出售留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">房屋出售留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">房屋出售留言列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(yonghuNameCell);
                ...
                //留言内容
            var chushouLiuyanContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.chushouLiuyanContent && item.chushouLiuyanContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.chushouLiuyanContent.indexOf('<img');
                var endIndex = item.chushouLiuyanContent.indexOf('>');
                    chushouLiuyanContentCell.innerHTML = item.chushouLiuyanContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.chushouLiuyanContent != null && item.chushouLiuyanContent != "" && item.chushouLiuyanContent.length >= 11) {
                        chushouLiuyanContentCell.innerHTML = item.chushouLiuyanContent.substring(0, 10) + "...";
                } else {
                        chushouLiuyanContentCell.innerHTML = item.chushouLiuyanContent;
                }
            }
            row.appendChild(chushouLiuyanContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chushouLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchushouLiuyan", "addchushouLiuyan");
            window.location.href = "add-or-update.jsp"
        }
