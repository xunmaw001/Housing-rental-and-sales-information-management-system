...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">房屋出售订单管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">房屋出售订单列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">房屋出售订单列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //总价
            var chushouOrderMoneyCell = document.createElement('td');
            chushouOrderMoneyCell.innerHTML = item.chushouOrderMoney;
            row.appendChild(chushouOrderMoneyCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chushouOrder/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchushouOrder", "addchushouOrder");
            window.location.href = "add-or-update.jsp"
        }
