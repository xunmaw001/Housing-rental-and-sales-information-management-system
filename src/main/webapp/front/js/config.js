...
var centerMenu = [
    ...
    ,{
        name: '房屋出售订单',
        url: '../chushouOrder/list.jsp'
    }
    ,{
        name: '房屋出租订单',
        url: '../chuzuOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '房屋出售',
        url: './pages/chushou/list.jsp'
    },
    {
        name: '房屋出租',
        url: './pages/chuzu/list.jsp'
    },
    {
        name: '公告',
...
var adminurl =  "http://localhost:8080/fangwuzusougaunli/index.jsp";
