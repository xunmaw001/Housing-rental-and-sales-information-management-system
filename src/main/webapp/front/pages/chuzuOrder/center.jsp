	...
	<body style="background: #EEEEEE;">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							<label class="layui-form-label">租房时间/月</label>
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chuzuOrderDay" id="chuzuOrderDay"  lay-verify="required|integer"   placeholder="租房时间/月" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="chuzuOrderMoney" id="chuzuOrderMoney"  lay-verify="required|double"   placeholder="总价" autocomplete="off" class="layui-input" style="width: 500px">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chuzuOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
