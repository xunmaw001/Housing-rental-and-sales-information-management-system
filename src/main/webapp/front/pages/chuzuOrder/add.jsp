    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="chuzu.insertTime" type="text"  readonly="readonly" name="insertTime" id="insertTime" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="detail.chuzuOrderDay" type="text" name="chuzuOrderDay" id="chuzuOrderDay" lay-verify="integer|required"   placeholder="租房时间/月" autocomplete="off" class="layui-input">
                </div>
            </div>
