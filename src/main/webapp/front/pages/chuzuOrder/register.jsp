              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">租房时间/月:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="chuzuOrderDay" id="chuzuOrderDay"  lay-verify="integer|required"   placeholder="租房时间/月" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="chuzuOrderMoney" id="chuzuOrderMoney"  lay-verify="double|required"   placeholder="总价" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
