            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">房屋出租展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="chuzuName" id="chuzuName" placeholder="房屋名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../chuzu/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.chuzuPhoto?item.chuzuPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../chuzu/detail.jsp?id='+item.id)"><span>{{item.chuzuName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.chuzuNewMoney"><span style="color: red;">{{item.chuzuNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 chuzuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            chuzuContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#chuzuName').val() != null && jquery('#chuzuName').val() != "" && jquery('#chuzuName').val() != "null" ) {
                param['chuzuName'] = jquery('#chuzuName').val();
            }
            ...
            if (huixingTypes != null && huixingTypes != "" && huixingTypes != "null") {
                param['huixingTypes'] = huixingTypes;
                                                                            ...
                                                                            // 获取列表数据
            http.request('chuzu/list', 'get', param, function(res) {
