                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="chushouOrderMoney" id="chushouOrderMoney"  lay-verify="double|required"   placeholder="总价" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
