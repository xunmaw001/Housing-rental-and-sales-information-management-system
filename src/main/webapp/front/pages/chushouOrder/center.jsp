	...
	<body style="background: #EEEEEE;">
			...
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="chushouOrderMoney" id="chushouOrderMoney"  lay-verify="required|double"   placeholder="总价" autocomplete="off" class="layui-input" style="width: 500px">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chushouOrder/session`, 'get', {}, function (data) {
                    // 表单赋值
