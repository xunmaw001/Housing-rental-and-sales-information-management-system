 ...
 * @date 2021-04-29
 */
@TableName("chushou_liuyan")
public class ChushouLiuyanView extends ChushouLiuyanEntity implements Serializable {
	...
	public ChushouLiuyanView() {

	}

	public ChushouLiuyanView(ChushouLiuyanEntity chushouLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, chushouLiuyanEntity);
