 ...
 */
@TableName("chushou")
public class ChushouView extends ChushouEntity implements Serializable {
	...
	public ChushouView(ChushouEntity chushouEntity) {
		try {
			BeanUtils.copyProperties(this, chushouEntity);
